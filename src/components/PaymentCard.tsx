...
import { DEFAULT_PAYMENT } from '@/lib/demo';
import type { PaymentIntent } from '@/lib/demo';

/**
 * The confirmation step. One tap, one amount, no PIN pad — every extra step here
 * is time the participant spends on mechanics instead of on the question we are
  ...
  return (
    <div className="card animate-fade-up overflow-hidden">
      <div className="flex items-center gap-2 border-b border-line bg-sunken px-4 py-3">
        ...
        <span className="label-eyebrow text-ink-muted">Payment ready</span>
      </div>
      ...
      <div className="px-4 py-4">
        ...
        {state === 'done' ? null : (
          ...
          >
            ...
            {state === 'working' ? 'Processing…' : 'Confirm payment'}
          </button>
        )}
      </div>
    </div>
